...
<METAHTTP-EQUIV="Expires"CONTENT="0">
    ...
    <title>My JSP 'my_company.jsp' starting page</title>
...
<div class="big_czmm_content">
	<div class="czmm_content">
		...
		<div class="buzhou">
			<div class="buzhou_01 lv"></div>
			<div class="kuai kuai_01"></div>
			<div class="buzhou_01 lv">企业资料</div>
			<div class="kuai kuai_02"></div>
			<div class="buzhou_01 lv"></div>
		</div>
		<form method="post" action="ModEmployer">
				<div class="nr">
			<div class="nr_03">
				<div class="queren" style="margin-left:140px;margin-top:0px;">
					<div class="text"><%=em.getFilmid() %></div>
					<input class="biaoti" type="hidden" name="filmid" value="<%=em.getFilmid() %>">
					<div>
					<input class="biaoti" type="text" name="place" value="<%=em.getPlace() %>"  autocomplete="off">
					</div>
					<div>
					<input class="biaoti" type="text" name="filmnum" value="<%=em.getFilmnum() %>">
					</div>
					<div>
					<input class="biaoti" type="text" name="fimdata" value="<%=em.getFilmdata() %>"  style="width:250%">
					</div>
					<br>
					<b><input type="submit" value="确认修改" class="input_11" οnclick="javascript:window.location.reload();"></b>
				</div>
			</div>
		</div>
		</form>
